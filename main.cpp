    ...
    char opt = '1';
        while(opt != '0')
        {
            ...
            if(opt == 'e' || opt == 'E')
            {
                ...
                cout << "Deseja aplicar Prim no grafo inteiro?"<< endl;
                cout << "1-Sim" << endl;
                cout << "0-Nao(Aperte qualquer tecla)" << endl;
                cin >> opt2;
                if(opt2 == '1')
                {
                    SubOrder = grafo->getOrder();
            ...
            {   
                ...
                cout << "Deseja aplicar Kruskal no grafo inteiro?"<< endl;
                cout << "1-Sim" << endl;
                cout << "0-Nao(Aperte qualquer tecla)" << endl;
                cin >> opt2;
                if(opt2 == '1')
